...
module AftershipAPI::Model
  class FirstEstimatedDeliveryRetrackTrackingByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::FirstEstimatedDeliveryRetrackTrackingByIdResponse` initialize method"
      end
