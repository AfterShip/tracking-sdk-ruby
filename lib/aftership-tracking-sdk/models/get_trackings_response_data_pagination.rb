...
module AftershipAPI::Model
  class GetTrackingsResponseDataPagination
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::GetTrackingsResponseDataPagination` initialize method"
      end
