...
module AftershipAPI::Model
  class LastMileCreateTrackingResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::LastMileCreateTrackingResponse` initialize method"
      end
