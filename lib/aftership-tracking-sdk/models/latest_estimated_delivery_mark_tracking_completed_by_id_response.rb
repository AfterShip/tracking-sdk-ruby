...
module AftershipAPI::Model
  class LatestEstimatedDeliveryMarkTrackingCompletedByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::LatestEstimatedDeliveryMarkTrackingCompletedByIdResponse` initialize method"
      end
