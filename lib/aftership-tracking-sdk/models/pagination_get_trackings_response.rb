...
module AftershipAPI::Model
  class PaginationGetTrackingsResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::PaginationGetTrackingsResponse` initialize method"
      end
