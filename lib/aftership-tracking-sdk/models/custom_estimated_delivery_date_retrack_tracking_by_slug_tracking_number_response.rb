...
module AftershipAPI::Model
  class CustomEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::CustomEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse` initialize method"
      end
