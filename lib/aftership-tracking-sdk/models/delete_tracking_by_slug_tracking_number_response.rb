...
module AftershipAPI::Model
  class DeleteTrackingBySlugTrackingNumberResponse
    # Tracking ID.
    # id?: String;
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::DeleteTrackingBySlugTrackingNumberResponse` initialize method"
      end
    ...
    def self.openapi_types
      {
        ...
        :'courier_connection_id' => :'String',
        :'next_couriers' => :'Array<NextCouriersDeleteTrackingBySlugTrackingNumberResponse>',
        :'tracking_origin_country' => :'String',
        :'tracking_destination_country' => :'String',
        :'tracking_postal_code' => :'String',
        :'tracking_state' => :'String',
