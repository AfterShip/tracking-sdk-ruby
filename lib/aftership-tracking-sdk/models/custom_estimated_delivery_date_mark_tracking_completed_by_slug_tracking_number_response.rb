...
module AftershipAPI::Model
  class CustomEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::CustomEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse` initialize method"
      end
