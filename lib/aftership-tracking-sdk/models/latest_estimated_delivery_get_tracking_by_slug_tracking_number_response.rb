...
module AftershipAPI::Model
  class LatestEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::LatestEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse` initialize method"
      end
