...
module AftershipAPI::Model
  class LatestEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::LatestEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse` initialize method"
      end
