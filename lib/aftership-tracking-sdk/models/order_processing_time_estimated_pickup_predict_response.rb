...
module AftershipAPI::Model
  class OrderProcessingTimeEstimatedPickupPredictResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::OrderProcessingTimeEstimatedPickupPredictResponse` initialize method"
      end
