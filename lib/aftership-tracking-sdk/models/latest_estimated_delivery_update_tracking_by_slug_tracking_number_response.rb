...
module AftershipAPI::Model
  class LatestEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::LatestEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse` initialize method"
      end
