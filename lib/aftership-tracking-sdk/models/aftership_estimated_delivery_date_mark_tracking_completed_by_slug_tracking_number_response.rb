...
module AftershipAPI::Model
  class AftershipEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::AftershipEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse` initialize method"
      end
