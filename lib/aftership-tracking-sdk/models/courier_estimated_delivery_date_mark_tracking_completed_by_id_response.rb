...
module AftershipAPI::Model
  class CourierEstimatedDeliveryDateMarkTrackingCompletedByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::CourierEstimatedDeliveryDateMarkTrackingCompletedByIdResponse` initialize method"
      end
