...
module AftershipAPI::Model
  class OrderProcessingTimeEstimatedPickupPredictRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::OrderProcessingTimeEstimatedPickupPredictRequest` initialize method"
      end
