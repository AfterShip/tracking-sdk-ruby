...
module AftershipAPI::Model
  class FirstEstimatedDeliveryGetTrackingByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::FirstEstimatedDeliveryGetTrackingByIdResponse` initialize method"
      end
