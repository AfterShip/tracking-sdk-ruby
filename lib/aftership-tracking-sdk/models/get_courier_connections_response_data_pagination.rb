...
module AftershipAPI::Model
  class GetCourierConnectionsResponseDataPagination
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::GetCourierConnectionsResponseDataPagination` initialize method"
      end
