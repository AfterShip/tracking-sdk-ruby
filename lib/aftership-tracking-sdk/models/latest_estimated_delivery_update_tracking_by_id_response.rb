...
module AftershipAPI::Model
  class LatestEstimatedDeliveryUpdateTrackingByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::LatestEstimatedDeliveryUpdateTrackingByIdResponse` initialize method"
      end
