...
module AftershipAPI::Model
  class CourierEstimatedDeliveryDateGetTrackingByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::CourierEstimatedDeliveryDateGetTrackingByIdResponse` initialize method"
      end
