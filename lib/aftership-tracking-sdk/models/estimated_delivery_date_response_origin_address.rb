...
module AftershipAPI::Model
  class EstimatedDeliveryDateResponseOriginAddress
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::EstimatedDeliveryDateResponseOriginAddress` initialize method"
      end
