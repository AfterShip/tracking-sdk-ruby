...
module AftershipAPI::Model
  class LatestEstimatedDeliveryRetrackTrackingByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::LatestEstimatedDeliveryRetrackTrackingByIdResponse` initialize method"
      end
