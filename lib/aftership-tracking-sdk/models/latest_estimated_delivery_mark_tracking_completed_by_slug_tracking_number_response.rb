...
module AftershipAPI::Model
  class LatestEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::LatestEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse` initialize method"
      end
