...
module AftershipAPI::Model
  class PredictBatchResponseData
    # 
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::PredictBatchResponseData` initialize method"
      end
    ...
    def self.openapi_types
      {
        :'estimated_delivery_dates' => :'Array<EstimatedDeliveryDateResponse>',
      }
    end
