...
module AftershipAPI::Model
  class CustomEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::CustomEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse` initialize method"
      end
