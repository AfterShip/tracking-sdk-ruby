...
module AftershipAPI::Model
  class FirstEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::FirstEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse` initialize method"
      end
