...
module AftershipAPI::Model
  class LatestEstimatedDeliveryCreateTrackingResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::LatestEstimatedDeliveryCreateTrackingResponse` initialize method"
      end
