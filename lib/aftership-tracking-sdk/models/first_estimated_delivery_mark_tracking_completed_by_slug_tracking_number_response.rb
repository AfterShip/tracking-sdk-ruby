...
module AftershipAPI::Model
  class FirstEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::FirstEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse` initialize method"
      end
