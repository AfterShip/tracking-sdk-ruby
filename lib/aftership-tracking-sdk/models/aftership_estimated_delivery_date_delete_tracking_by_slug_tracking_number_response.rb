...
module AftershipAPI::Model
  class AftershipEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::AftershipEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse` initialize method"
      end
