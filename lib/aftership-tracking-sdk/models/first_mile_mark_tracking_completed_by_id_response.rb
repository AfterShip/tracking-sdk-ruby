...
module AftershipAPI::Model
  class FirstMileMarkTrackingCompletedByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::FirstMileMarkTrackingCompletedByIdResponse` initialize method"
      end
