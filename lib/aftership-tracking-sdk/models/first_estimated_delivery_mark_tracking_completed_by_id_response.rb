...
module AftershipAPI::Model
  class FirstEstimatedDeliveryMarkTrackingCompletedByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::FirstEstimatedDeliveryMarkTrackingCompletedByIdResponse` initialize method"
      end
