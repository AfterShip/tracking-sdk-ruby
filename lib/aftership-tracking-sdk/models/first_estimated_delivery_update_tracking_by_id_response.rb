...
module AftershipAPI::Model
  class FirstEstimatedDeliveryUpdateTrackingByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::FirstEstimatedDeliveryUpdateTrackingByIdResponse` initialize method"
      end
