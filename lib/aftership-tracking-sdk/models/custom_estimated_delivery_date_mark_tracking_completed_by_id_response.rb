...
module AftershipAPI::Model
  class CustomEstimatedDeliveryDateMarkTrackingCompletedByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::CustomEstimatedDeliveryDateMarkTrackingCompletedByIdResponse` initialize method"
      end
