...
module AftershipAPI::Model
  class LatestEstimatedDeliveryDeleteTrackingByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::LatestEstimatedDeliveryDeleteTrackingByIdResponse` initialize method"
      end
