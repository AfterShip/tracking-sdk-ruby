...
module AftershipAPI::Model
  class FirstEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::FirstEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse` initialize method"
      end
