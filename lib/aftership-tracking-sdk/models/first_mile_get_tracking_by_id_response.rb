...
module AftershipAPI::Model
  class FirstMileGetTrackingByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::FirstMileGetTrackingByIdResponse` initialize method"
      end
