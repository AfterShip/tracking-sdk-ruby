...
module AftershipAPI::Model
  class EstimatedDeliveryDateResponseEstimatedPickup
    ...
    # 
    # order_processing_time?: EstimatedDeliveryDateResponseEstimatedPickupOrderProcessingTime;
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::EstimatedDeliveryDateResponseEstimatedPickup` initialize method"
      end
