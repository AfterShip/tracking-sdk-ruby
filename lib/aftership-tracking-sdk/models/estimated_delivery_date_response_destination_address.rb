...
module AftershipAPI::Model
  class EstimatedDeliveryDateResponseDestinationAddress
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::EstimatedDeliveryDateResponseDestinationAddress` initialize method"
      end
