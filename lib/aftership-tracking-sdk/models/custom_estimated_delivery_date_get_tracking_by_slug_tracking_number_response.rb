...
module AftershipAPI::Model
  class CustomEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::CustomEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse` initialize method"
      end
