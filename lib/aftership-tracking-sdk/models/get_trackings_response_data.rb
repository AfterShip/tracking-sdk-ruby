...
module AftershipAPI::Model
  class GetTrackingsResponseData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::GetTrackingsResponseData` initialize method"
      end
