...
module AftershipAPI::Model
  class AftershipEstimatedDeliveryDateGetTrackingByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::AftershipEstimatedDeliveryDateGetTrackingByIdResponse` initialize method"
      end
