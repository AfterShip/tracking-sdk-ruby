...
module AftershipAPI::Model
  class AftershipEstimatedDeliveryDateMarkTrackingCompletedByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::AftershipEstimatedDeliveryDateMarkTrackingCompletedByIdResponse` initialize method"
      end
