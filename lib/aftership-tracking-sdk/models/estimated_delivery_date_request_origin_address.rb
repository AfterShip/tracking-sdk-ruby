...
module AftershipAPI::Model
  class EstimatedDeliveryDateRequestOriginAddress
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::EstimatedDeliveryDateRequestOriginAddress` initialize method"
      end
