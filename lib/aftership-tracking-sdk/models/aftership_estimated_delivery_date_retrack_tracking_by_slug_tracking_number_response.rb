...
module AftershipAPI::Model
  class AftershipEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::AftershipEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse` initialize method"
      end
