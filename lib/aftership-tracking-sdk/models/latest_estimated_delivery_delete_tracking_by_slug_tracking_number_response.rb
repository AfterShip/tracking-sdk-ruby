...
module AftershipAPI::Model
  class LatestEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::LatestEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse` initialize method"
      end
