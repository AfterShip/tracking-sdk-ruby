...
module AftershipAPI::Model
  class LatestEstimatedDeliveryGetTrackingByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::LatestEstimatedDeliveryGetTrackingByIdResponse` initialize method"
      end
