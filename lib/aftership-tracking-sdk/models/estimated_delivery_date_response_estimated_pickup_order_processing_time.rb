...
module AftershipAPI::Model
  class EstimatedDeliveryDateResponseEstimatedPickupOrderProcessingTime
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::EstimatedDeliveryDateResponseEstimatedPickupOrderProcessingTime` initialize method"
      end
