...
module AftershipAPI::Model
  class FirstEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::FirstEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse` initialize method"
      end
