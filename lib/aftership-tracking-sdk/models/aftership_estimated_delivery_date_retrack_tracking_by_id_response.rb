...
module AftershipAPI::Model
  class AftershipEstimatedDeliveryDateRetrackTrackingByIdResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AftershipAPI::AftershipEstimatedDeliveryDateRetrackTrackingByIdResponse` initialize method"
      end
